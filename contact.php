...
<body>
    ...
    <div class="container-fluid p-0 animate__animated animate__zoomIn content-for-large-width-screens">
        <div class="mask background-home content-for-large-width-screens overlay">
            ...
            <div class="d-flex justify-content-center">
                <div class="col-md-12 mt-5">
                    <div id="carousel-0" class="carousel slide carousel-fade mb-5 mt-3" data-ride="carousel">
                        <div class="carousel-inner content-for-large-width-screen">
                            <div class="carousel-item active">
                                <h4 class="text-white text-center">
                                    Hello, Welcome to our contacts page.
                                </h4>
                            </div>
                            <div class="carousel-item">
                                <h4 class="text-white text-center">
                                    We hope that you are enjoying your experience shopping with us
                                </h4>
                            </div>
                            <div class="carousel-item">
                                <h4 class="text-white text-center">
                                    We are more than delighted to serve you
                                </h4>
                            </div>
                            <div class="carousel-item">
                                <h4 class="text-white text-center">
                                    We care about you and we so much value your feedback
                                </h4>
                            </div>
                            <div class="carousel-item">
                                <h4 class="text-white  text-center">
                                    We are online now, scroll down to find our nearest shops, leave a comment or talk to us directly
                                </h4>
                            </div>
                        </div>
                        <div class="carousel-inner content-for-small-width-screens">
                            <div class="carousel-item active">
                                <h4 class="text-white text-center mt-4 pb-1">
                                    Hello, Welcome to our contacts page.
                                </h4>
                            </div>
                            <div class="carousel-item">
                            ...
                            <div class="carousel-item">
                                <h4 class="text-white mt-4 pb-1 text-center">
                                    We are more than delighted to serve you
                                </h4>
                            </div>
                            <div class="carousel-item">
                                <h4 class="text-white mt-4 pb-1 text-center mt-4">
                                    We care about you and we so much value your feedback
                                </h4>
                            </div>
                            <div class="carousel-item">
    ...
    <div class="modal fade" id="contactFormModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="d-flex justify-content-center">
                        <h1 class="text-warning text-center">Contact Form</h1>
                    </div>
                ...
                <div class="modal-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class=" nameInputForContactForm">
                            <span class="text-warning nameErr"></span>
                        </div>
                        <div class="form-group">
                            <label for="email">Enter your Email address:</label>
                            <input type="email" class=" emailInputForContactForm">
                            <span class="text-warning emailErr"></span>
                        </div>
                        <div class="form-group">
                            <label for="email">Message:</label>
                            <textarea class=" form-control messageBodyForContactForm messageAreaResizeFalse" rows="3"></textarea>
                            <span class="text-warning messageErr"></span>
                        </div>
                        <div class="form-group">
                            <input type="submit" class="btn btn-warning btn-lg shadow" value="Send" name="sendCotactInfo">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body bg-dark">
                    <div class="overflow-auto mb-5">
                        ...
                        <div aria-live="polite" aria-atomic="true" class="toastReply">
                            <div class="toast toastReplyLeftAligned" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false">
                                <div class="toast-header">
                                    <strong class="mr-auto">User</strong>
                                    <small>0 mins ago</small>
                                    <button type="button" class="ml-2 mb-1 close" data-dismiss="toast" aria-label="Close">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            <label for="email">Enter your Email address</label>
                            <input type="email" class="mt-1 mb-2" id="mail-auth-placeholder">
